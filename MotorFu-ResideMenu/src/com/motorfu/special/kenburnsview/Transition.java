 ...
 */
package com.motorfu.special.kenburnsview;
...
public class Transition {
    ...
    public RectF getInterpolatedRect(long elapsedTime) {
        ...
        float currentWidth = mSrcRect.width() + (interpolation * mWidthDiff/4);
        float currentHeight = mSrcRect.height() + (interpolation * mHeightDiff/4);
