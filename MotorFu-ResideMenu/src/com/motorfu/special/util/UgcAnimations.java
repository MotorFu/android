package com.motorfu.special.util;
...
public class UgcAnimations {
	...
	public static void initOffset(Context context) {
		xOffset = (int) (20 * context.getResources().getDisplayMetrics().density);
		yOffset = -(int) (48 * context.getResources().getDisplayMetrics().density);
	}
	...
	public static void startOpenAnimationRight(RelativeLayout relativeLayout,
		...
		for (int i = 0; i < relativeLayout.getChildCount(); i++) {
			...
			set.addAnimation(getAlphaAnimation(0.3f, 1.0f, durationMillis));
			set.addAnimation(getTranslateAnimation(
					params.rightMargin - xOffset, 0f, params.bottomMargin
	...
	public static void startCloseAnimationRight(final RelativeLayout relativeLayout,
		...
		for (int i = 0; i < relativeLayout.getChildCount(); i++) {
			...
			set.addAnimation(getTranslateAnimation(0f, params.rightMargin
			...
			set.setStartOffset(((relativeLayout.getChildCount() - i) * 100)
					/ (-1 + relativeLayout.getChildCount()));
			set.setInterpolator(new AnticipateInterpolator(0f));
