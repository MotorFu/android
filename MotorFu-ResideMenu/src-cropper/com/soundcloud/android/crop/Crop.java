...
public class Crop {
     ...
     */
    public void start(Activity activity, float width ,float height) {
    	System.out.println(width+"==========PhotoView=========="+height);
        activity.startActivityForResult(getIntent(activity).putExtra("width", width).putExtra("height", height), REQUEST_CROP);
    }
